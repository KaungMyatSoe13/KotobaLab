...
import { shuffleArray, speakWord } from "./utils";
import { storage } from "./storage";
import { downloadTemplate, parseExcelFile } from "./fileHandler";
...
const JapaneseVocabQuiz: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-slate-950 via-gray-950 to-slate-900 p-1 sm:p-6 md:p-8 overflow-auto">
